...
const NestedPropInput = ({nestedidx, nestedPropState, handleNestedTypeSelectChange, removeNestedProperty, handleNestedPropChange, errorProp}) => {
    ...
    const [nestedType, TypeOfNestedProp] = useDropdown("Type Of Prop (nested)", "", typeList, handleNestedTypeSelectChange, nestedidx);
