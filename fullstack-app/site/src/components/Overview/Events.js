...
import RefreshButton from '../RefreshButton/eventsRefresh';
...
<React.Fragment>
        ...
        <h4>
              ...
              <Breadcrumb.Item><Link to="/Events" style={{color: '#183045'}}>Events</Link></Breadcrumb.Item>
        </h4>              
        </Breadcrumb>
        </Col>
        </Row>
        ...
        <div className="antd-col ant-col ant-col-xs-24 ant-col-sm-12 ant-col-md-6">
            <div className="antd-card ant-card mb-4 ant-card-bordered" style={{backgroundColor: '#7b94b7', borderRadius: 5, minHeight: 144}}>
                <div className="ant-card-body">
                    <div className="ant-row-flex ant-row-flex-start ant-row-flex-middle">
                        <div className="ant-col">
                            <h4 className="text-white">Source</h4>
                            <h3 className="text-white"><SelectDropdownSource/></h3>
                        </div>
        ...
        <div className="antd-col ant-col ant-col-xs-24 ant-col-sm-12 ant-col-md-6">
            <div className="antd-card ant-card mb-4 ant-card-bordered" style={{backgroundColor: '#fada15', borderRadius: 5, minHeight: 144}}>
                <div className="ant-card-body">
                    <div className="ant-row-flex ant-row-flex-start ant-row-flex-middle">
                        <div className="ant-col">
                            <h4 className="text-white">Event Type</h4>
                            <h3 className="text-white"><SelectDropdown /></h3>
                        </div>
                        <span className="mr-auto"></span>
                        <div className="ant-col"></div>
                    </div>
        ...
        <div className="antd-col ant-col ant-col-xs-24 ant-col-sm-12 ant-col-md-6">
            <div className="antd-card ant-card mb-4 ant-card-bordered" style={{backgroundColor: '#fa8b15', borderRadius: 5, minHeight: 144}}>
                <div className="ant-card-body">
                    <div className="ant-row-flex ant-row-flex-start ant-row-flex-middle">
                        <div className="ant-col">
                            <h4 className="text-white">Version Number</h4>
                            <h3 className="text-white"><SelectDropdownVersionNumber /></h3>
                        </div>
                        <span className="mr-auto"></span>
                        <div className="ant-col"></div>
                    </div>
        ...
        <div className="antd-col ant-col ant-col-xs-24 ant-col-sm-12 ant-col-md-6">
            <div className="antd-card ant-card mb-4 ant-card-bordered" style={{backgroundColor: '#f6222e', borderRadius: 5, minHeight: 144}}>
                <div className="ant-card-body">
                    <div className="ant-row-flex ant-row-flex-start ant-row-flex-middle">
                        <div className="ant-col">
                            <h4 className="text-white">Date Range</h4>
                            <h3 className="text-white"><DateSelector /></h3>
                        </div>
                        <span className="mr-auto"></span>
                        <div className="ant-col"></div>
                    </div>
          ...
          <CsvDownload data={this.props.filteredEvents} filename="report_data.csv" style={{border: 0}}>
          <Button type="button" className="ant-btn ant-btn-lg" style={{backgroundColor: '#36bcb2', borderRadius: 5}}>
              <i aria-label="icon: download" className="anticon anticon-download">
                <svg viewBox="64 64 896 896" data-icon="download" width="2em" height="2em" fill="#ffffff" aria-hidden="true" focusable="true" style={{paddingBottom: 4}}>
          ...
          <Row style={{width: "100%", padding: 0, margin: 0, marginTop: 20}}>
            <Col span={24}><Table /></Col>
          </Row>

          <Row type="flex" align="middle" justify="center" className="linechart-events bg-error">
            <Col span={24}>
                    ...
                    <div className="ant-card-head">
                      <div className="ant-card-head-wrapper">
                        <div className="ant-card-head-title">
                          <h4 style={{color: '#f6222e'}}>Events Over Time</h4></div>
                      </div>
                    </div>
                      <div className="ant-card-body"><Linechart /></div>
              </div>
              </div>             
              </Col>
          </Row>
...
const mapStateToProps = state => {
  const { eventsWithDates, query, registeredEvents, sources, events, eventsReport, filteredEvents, selectedSources } = state.eventsReduc;
  return {
    query: query,
