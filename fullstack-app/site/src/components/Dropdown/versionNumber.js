...
const SelectDropdown = ({
  ...
  const FilteredEventTypes = registeredEvents.filter(
    (obj) =>
      selectedSources.includes(obj.source) &&
      selectedEventType.includes(obj.typeName)
  );

  const versionNumber = [
    ...new Set([...FilteredEventTypes.map((obj) => obj.versionNumber)]),
  ];
